 ...
 *
 * @param {HTMLImageElement|ImageBitmap} image 要提取像素的图像。
 * @param {number} width 图像的宽度。如果未定义，则使用 image.width。
 * @param {number} height 图像的高度。如果未定义，则使用 image.height。
 * @returns {ImageData} 图像的像素数据。
 */
