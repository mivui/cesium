 ...
 * @param {RectangleOutlineGeometry} [result] 要在其中存储结果的对象。
 * @returns {RectangleOutlineGeometry} 修改后的结果参数或者新的 Quaternion 实例（如果未提供）。
 */
