 ...
 * @param {ScreenSpaceEventType} type 输入事件的屏幕空间事件类型。
 * @param {KeyboardEventModifier[] | KeyboardEventModifier} [modifiers] <code>type</code> 事件发生时按下的 KeyboardEventModifier 键。
 *
