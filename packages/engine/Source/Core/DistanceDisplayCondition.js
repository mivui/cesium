 ...
 * @constructor
 *
 * @param {number} [near=0.0] 对象可见区间中的最小距离。
 * @param {number} [far=Number.MAX_VALUE] 对象可见区间中的最大距离。
 *
 * @example
 * // 创建一个仅在距离相机10到20米之间可见的公告板。
 ...
 * @returns {DistanceDisplayCondition} 修改后的结果参数；如果未提供则返回新的DistanceDisplayCondition实例。
 */
 ...
 * @param {DistanceDisplayCondition} [result] 存储结果的对象。
 * @return {DistanceDisplayCondition} 复制后的实例。
 */
