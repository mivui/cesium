...
/**
 * @private
 * @param {object} readState  对象，具有以下属性:
 ...
 * @param {number} [readState.width=gl.drawingBufferWidth] 宽度 rectangle to read from.
 * @param {number} [readState.height=gl.drawingBufferHeight] 高度 rectangle to read from.
