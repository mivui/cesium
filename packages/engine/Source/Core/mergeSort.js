 ...
 *
 * @function mergeSort
 * @param {Array|Int8Array|Uint8Array|Int16Array|Uint16Array|Int32Array|Uint32Array|Float32Array|Float64Array} array 要排序的数组。
 * @param {mergeSortComparator} comparator 用于比较数组中元素的函数。
 * @param {*} [userDefinedObject] 要作为第三个参数传递给 <code>comparator</code> 的任何对象。
 *
 * @example
 ...
 *          如果 <code>a</code> 大于 <code>b</code> 则返回正值，或者
